<?php
    ...
    if($type == 'last') {
        $count = count($microtraumas_student_full_line);
        if($count > 0) {
            foreach($microtraumas_student_full_line as $line) {
?>
...
<?php
        ...
        $count = count($microtraumas_student_archive_full_line);

        if($count > 0) {
            foreach($microtraumas_student_archive_full_line as $line) {
?>
            <div class="row-microtr">
