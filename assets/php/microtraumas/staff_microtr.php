<?php
    ...
    if($type == 'last') {
        $count = count($microtraumas_staff_full_line);

        if($count > 0) {
            foreach($microtraumas_staff_full_line as $line) {
?>
...
<?php
        ...
        $count = count($microtraumas_staff_archive_full_line);

        if($count > 0) {
            foreach($microtraumas_staff_archive_full_line as $line) {
?>
            <div class="row-microtr">
